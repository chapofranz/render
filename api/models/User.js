module.exports = {
  attributes: {
    // vorname: { type: 'string', columnType: 'varchar(80)', required: false },
    // nachname: { type: 'string', columnType: 'varchar(80)', required: false },
  ...
  email status until they click the link in the confirmation email.`
    ...
    vorName: {
      type: 'string',
      required: true,
      description: 'First Name of the user\'s Fullname.',
      maxLength: 120,
    ...
    nachName: {
      type: 'string',
      required: true,
      description: 'Second name of the user\'s Fullname.',
      maxLength: 120,
